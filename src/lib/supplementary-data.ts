...
// Values reflect real AI-agent workflows: prompt → generate → verify → iterate.
const AI_NATIVE_SCOPE_BASELINES: Record<string, ScopeBaseline> = {
  feature:        { small: 0.5, medium: 2.0, large: 5.0, xl: 12.0 },
  bugfix:         { small: 0.1, medium: 1.0, large: 3.0, xl: 6.0 },
  infrastructure: { small: 0.3, medium: 1.5, large: 4.0, xl: 10.0 },
  testing:        { small: 0.1, medium: 1.0, large: 3.0, xl: 8.0 },
  refactor:       { small: 0.5, medium: 1.5, large: 4.0, xl: 10.0 },
  documentation:  { small: 0.2, medium: 1.0, large: 3.0, xl: 6.0 },
  design:         { small: 0.5, medium: 2.0, large: 5.0, xl: 12.0 },
  migration:      { small: 0.5, medium: 2.0, large: 6.0, xl: 16.0 },
};
