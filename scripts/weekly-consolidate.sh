...
NUC_HOST="${EPOCH_NUC_HOST:-root@100.113.174.74}"
NUC_DATA_DIR="${EPOCH_NUC_DATA_DIR:-/srv/data/epoch}"
LAPTOP_HOST="${EPOCH_LAPTOP_HOST:-100.123.79.5}"
...
This PR was auto-generated by the weekly consolidation launchd job on host." \
        --base main \
        --head "$PR_BRANCH" \
