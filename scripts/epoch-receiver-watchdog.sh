...
TAILNET_HOST="${EPOCH_RECEIVER_TAILNET_HOST:-gpu-host..ts.net}"
...
COMPOSE_DIR="${EPOCH_RECEIVER_COMPOSE_DIR:-/srv/containers/gpu-host/epoch}"
COMPOSE_SERVICE="${EPOCH_RECEIVER_COMPOSE_SERVICE:-epoch}"
CONTAINER_NAME="${EPOCH_RECEIVER_CONTAINER:-gpu-host-epoch}"
